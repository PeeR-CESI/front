...
import 'dropmenu_model.dart';
export 'dropmenu_model.dart';
...
class _DropmenuWidgetState extends State<DropmenuWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropmenuModel());
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'krsp1y8q' /* randy.p@domainname.com */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
