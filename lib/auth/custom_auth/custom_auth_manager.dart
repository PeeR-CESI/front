...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    testAuthUserSubject.add(
      TestAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TestAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TestAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TestAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    testAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
